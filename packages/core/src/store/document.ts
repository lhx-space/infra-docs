...
import * as documentService from '@luhanxin/api-client';
import * as linkPreviewService from '@luhanxin/api-client';
import * as uploadService from '@luhanxin/api-client';
import * as videoService from '@luhanxin/api-client';
