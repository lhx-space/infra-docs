...
import * as wikiService from '@luhanxin/api-client';
import * as joinRequestService from '@luhanxin/api-client';
import * as shareLinkService from '@luhanxin/api-client';
